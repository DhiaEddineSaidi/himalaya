  ...
  while (state.position.index < len) {
    ...
    if (state.position.index === start) {
      ...
      if (isComment) {
        ...
        var safeTag = state.options.tagNameToLowerCase ? tagName.toLowerCase() : tagName;
...
function lexSkipTag(tagName, state) {
  ...
  var safeTagName = state.options.tagNameToLowerCase ? tagName.toLowerCase() : tagName;
  var len = str.length;
  ...
  while (index < len) {
    ...
    var name = state.options.tagNameToLowerCase ? lexTag(tagState).toLowerCase() : lexTag(tagState);
    if (safeTagName !== name) {
...
function parse(state) {
  ...
  while (cursor < len) {
    ...
    cursor++;
    var tagName = state.options.tagNameToLowerCase ? tagToken.content.toLowerCase() : tagToken.content;
    if (token.close) {
